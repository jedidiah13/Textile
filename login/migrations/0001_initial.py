...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'login_userprofile', (
            ...
            ('appExpiryDate', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        db.send_create_signal(u'login', ['UserProfile'])

        # Adding model 'Key'
        db.create_table(u'login_key', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=38)),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login.UserProfile'], null=True)),
            ('keyExpiryDate', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'login', ['Key'])
    ...
    models = {
        ...
        u'login.key': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '38'}),
            'keyExpiryDate': ('django.db.models.fields.DateField', [], {}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['login.UserProfile']", 'null': 'True'})
        },
        u'login.userprofile': {
