...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.orders'
        db.alter_column(u'login_userprofile', 'orders_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webstore.Order']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.orders'
        db.alter_column(u'login_userprofile', 'orders_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['login.Order']))
    ...
    models = {
        ...
        u'login.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orders': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['webstore.Order']"}),
