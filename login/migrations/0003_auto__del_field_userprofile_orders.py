...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.orders'
        db.delete_column(u'login_userprofile', 'orders_id')


    def backwards(self, orm):
        # Adding field 'UserProfile.orders'
        db.add_column(u'login_userprofile', 'orders',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['webstore.Order']),
                      keep_default=False)
