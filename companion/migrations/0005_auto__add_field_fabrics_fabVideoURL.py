...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fabrics.fabVideoURL'
        db.add_column(u'companion_fabrics', 'fabVideoURL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fabrics.fabVideoURL'
        db.delete_column(u'companion_fabrics', 'fabVideoURL')
