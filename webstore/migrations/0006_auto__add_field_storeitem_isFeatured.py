...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItem.isFeatured'
        db.add_column(u'webstore_storeitem', 'isFeatured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItem.isFeatured'
        db.delete_column(u'webstore_storeitem', 'isFeatured')
