...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topics.fabCatagory'
        db.add_column(u'companion_topics', 'fabCatagory',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['companion.Catagories']),
                      keep_default=False)

        # Deleting field 'Fabrics.fabCatagory'
        db.delete_column(u'companion_fabrics', 'fabCatagory_id')


        # Changing field 'Fabrics.fabDescription'
        db.alter_column(u'companion_fabrics', 'fabDescription', self.gf('django.db.models.fields.CharField')(max_length=8192))

    def backwards(self, orm):
        # Deleting field 'Topics.fabCatagory'
        db.delete_column(u'companion_topics', 'fabCatagory_id')

        # Adding field 'Fabrics.fabCatagory'
        db.add_column(u'companion_fabrics', 'fabCatagory',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['companion.Catagories']),
                      keep_default=False)


        # Changing field 'Fabrics.fabDescription'
        db.alter_column(u'companion_fabrics', 'fabDescription', self.gf('django.db.models.fields.CharField')(max_length=1024))
